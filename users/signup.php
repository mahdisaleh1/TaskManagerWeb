    ...
    if ($result) {
        if (mysqli_num_rows($result) === 1) {
            ...
            if ($user['role'] === 'admin') {
                ...
                echo '<script>alert("Hello ' . $user['name'] . '! You are already logged in.")</script>';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result) {
        if (mysqli_num_rows($result) > 0) {
            ...
            $stmt = "INSERT INTO users (name, email, password, phone, role, status) VALUES ('$name', '$email', '$password', '$phone', 'user', 'active')";
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card shadow-sm">
                            <div class="card-header bg-primary text-white text-center">
                                <h2 class="mb-2"><i class="fas fa-user-plus mr-2"></i>Sign Up</h2>
                            </div>
                            <div class="card-body">
                                <?php
