...
<head>
    ...
    <title>Importants ~ Task Manager</title>
</head>
            ...
            <nav>
                <div class="d-flex flex-column bg-light vh-100 p-3" style="width: 220px;">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2">
                            <a class="nav-link active" href="../manage/important.php"><i class="fas fa-star mr-2"></i>Important</a>
                        </li>
                        <li class="nav-item mb-2">
                ...
                <div class="row justify-content-center w-100">
                    ...
                    <div class="card shadow-sm" style="width:100%; max-width:100%; min-height:600px;">
                        <div class="card-header bg-primary text-white text-center">
                            <h2 class="mb-2"><i class="fas fa-star mr-2"></i> Important Tasks</h2>
                        </div>
                        <div class="card-body">
                            <?php
                            ...
                            <div class="mb-3 d-flex justify-content-between align-items-center flex-wrap">
                                <div class="flex-grow-1 mr-2 mb-2">
                                    <input type="text" class="form-control mb-3" id="searchInput" placeholder="Search Important..." onkeyup="searchProjects()">
                                    <script>
                                ...
                                <div class="mb-4">
                                    <!--<a href="addproject.php" class="btn btn-success"><i class="fas fa-plus mr-2"></i>Add New Important</a>-->
                                    <button type="button" class="btn btn-success" onclick="openAddNewModal()"><i class="fas fa-plus mr-2"></i>Add New Important</button>
                                </div>
                            </div>
                            <?php
                            $user_id = $_SESSION['user_id'];
                            $tasks_query = "SELECT t.*, p.name AS project_name FROM tasks t LEFT JOIN projects p ON t.project_id = p.id WHERE t.user_id = '$user_id' AND priority='high' ORDER BY t.due_date DESC";
                            ...
                            <div class="modal fade" id="AddTaskModal" tabindex="-1" role="dialog" aria-labelledby="addTaskModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form method="post" action="">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="updateTaskModalLabel">Add New Important</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="update_project">Project</label>
                                                    <select class="form-control" name="newTaskproject" id="newTaskproject">
                                                        <option value="">None</option>
                                                        <?php
                                                ...
                                                <div class="form-group">
                                                    <label for="update_priority">Priority</label>
                                                    <select class="form-control" name="newTask_priority" id="newTask_priority" disabled>
