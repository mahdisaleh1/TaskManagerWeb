                ...
                <div class="row justify-content-center w-100">
                    ...
                    <div class="card shadow-sm" style="width:100%; max-width:100%; min-height:600px;">
                        <div class="card-header bg-primary text-white text-center">
                            <h2 class="mb-2"><i class="fas fa-tasks mr-2"></i>All Tasks</h2>
                        </div>
                        <div class="card-body">
                            <?php
                            ...
                            <div class="mb-3 d-flex justify-content-between align-items-center flex-wrap">
                                <div class="flex-grow-1 mr-2 mb-2">
                                    <input type="text" class="form-control mb-3" id="searchInput" placeholder="Search Tasks..." onkeyup="searchProjects()">
                                    <script>
                            ...
                            <?php
                            $user_id = $_SESSION['user_id'];
                            $tasks_query = "SELECT t.*, p.name AS project_name FROM tasks t LEFT JOIN projects p ON t.project_id = p.id WHERE t.user_id = '$user_id' ORDER BY t.due_date DESC";
